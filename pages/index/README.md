...
---
<div>
    <!-- <script src="https://teedoc.github.io/static/js/scrolloverflow.min.js"></script> -->
    <script src="https://teedoc.github.io/static/js/jquery.fullpage.min.js"></script>
    <link rel="stylesheet" href="https://teedoc.github.io/static/css/jquery.fullpage.min.css" type="text/css"/>
</div>
...
<div id="fullpage">
    ...
    <div class="section dsc_wrapper_left">
        <div>
            ...
            <div class="dsc_right">
                使用 <img class="logo" src="https://teedoc.github.io/static/image/markdown.svg"> Markdown 或者 <img class="logo" src="https://teedoc.github.io/static/image/jupyter.svg">jupyter notebook 书写，</br>
                自动生成 HTML 页面
            </div>
        </div>
    </div>
    ...
    <div class="section dsc_wrapper_left">
        <div>
            ...
            <div class="dsc_right">
                <img class="logo" src="https://teedoc.github.io/static/image/books.svg"> 支持多文档，每篇文档有单独的目录，也可以多版本。你的大量文档再也不用散落在各个域名下了！</br>
                <img class="logo" src="https://teedoc.github.io/static/image/blog.svg"> 同时支持轻量博客系统
            </div>
        </div>
    </div>
    <div class="section dsc_wrapper_right">
        <div>
            <div class="dsc_left">
                <img class="logo" src="https://teedoc.github.io/static/image/theme.svg"> 默认主题为高效阅读而设计，提供主题插件支持</br>
        ...
        <div>
            ...
            <div class="dsc_right">
                <img class="logo" src="https://teedoc.github.io/static/image/speed.svg"> 并行构建，充分利用处理器性能，文档渲染就在一瞬间</br>
                <img class="logo" src="https://teedoc.github.io/static/image/browser.svg"> 支持浏览器实时预览修改
            </div>
        </div>
    </div>
    <div class="section dsc_wrapper_right">
    ...
    <div class="section" style="height: 100vh;">
        <div class="big_btn_wrapper">
            <div class="big_btn">
                <a href="/get_started/">查看详细介绍</a>
            </div>
            <div class="big_btn">
                <a href="/get_started/quick_start.html">快速上手</a>
            </div>
        </div>
    </div>
</div>
